...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="group/accordion-content overflow-hidden text-xs data-open:animate-accordion-down data-closed:animate-accordion-up data-[state=open]:overflow-visible"
      {...props}
    >
      <div
        className={cn(
          "h-(--radix-accordion-content-height) pt-0 pb-2.5 group-data-[state=open]/accordion-content:h-auto [&_a]:underline [&_a]:underline-offset-3 [&_a]:hover:text-foreground [&_p:not(:last-child)]:mb-4",
          className
        )}
      >
        {children}
